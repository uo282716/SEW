...
class Geolocalización {
    ...
    verTodo(){
        ...
        var datos='<h2>Datos de Ubicación</h2>'; 
    ...
    getMapaEstaticoGoogle(){
        ...
        ubicacion.innerHTML = "<h2>Datos de Ubicación</h2><img src='"+this.imagenMapa+"' alt='mapa estático google' />";
    }
}
var miMapa = new Geolocalización();